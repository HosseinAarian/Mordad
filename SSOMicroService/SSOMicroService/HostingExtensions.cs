...
using SSOMicroService.Context;
using SSOMicroService.Services.Implementations;
...
internal static class HostingExtensions
{
	...
	public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
	{
		...
		{
			options.UseSqlServer(builder.Configuration.GetConnectionString("SSOConnectionString"));
		});
		//---------------------------------------------------------------------------

		builder.Services.AddScoped<SSOMicroService.Services.Interfaces.IUserService, SSOMicroService.Services.Implementations.UserService>();
